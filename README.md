...
Research engineering for AI-agent evaluation, context health, and reliable AI
workflows.

I build local-first evaluation artifacts that make AI workflow inputs easier to
inspect before an agent acts on them. My current focus is CtxGov: Agent Context
Health Evaluation for AI Workflows.
